  ...
  <div class="footer-container">
    <footer>
      <ul class="icon-links mx-auto">
        <a href="https://www.linkedin.com/in/levi-crietee-84ab74145/">
          <li class="icon-link">
            <img
            ...
            /></li
        ></a>
        <a href="https://github.com/levicr1998">
          <li class="icon-link">
            <img
            ...
            /></li
        ></a>
        <a href="https://www.instagram.com/levicrietee/">
          <li class="icon-link">
            <img
            ...
            /></li
        ></a>
        <a href="https://www.facebook.com/levi.crietee">
          <li class="icon-link">
            <img
